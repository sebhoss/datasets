...
p. Create random longs:

bc. // Create 100 random longs between Integer.MIN_VALUE and Integer.MAX_VALUE
Datasets.longs()
        .build();

bc. // Create 10 random longs between -5000 and 375
Datasets.longs()
        .lowestInclusive(-5000)
        .highestInclusive(375)
        .numbersToCreate(10)
        .build();

bc. // Create 100 random longs between 0 and Integer.MAX_VALUE using '42' as seed
Datasets.longs()
        .lowestInclusive(0)
        .seed(42)
        .build();
